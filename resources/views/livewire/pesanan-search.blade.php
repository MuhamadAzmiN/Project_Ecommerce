            ...
            <tbody>
                ...
                @else
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                           <img src="{{ $item->barang->image }}" class="w-20 h-20 object-cover" alt="Product Image">
                        </td>
                        ...
                        <td class="px-6 py-4 flex items-center gap-2 mt-5">
                            <a onclick="ShowModal({{ $item->id }}, '{{ $item->barang->nama_barang }}', {{ $item->jumlah_barang }}, {{ $item->barang->id }})"
