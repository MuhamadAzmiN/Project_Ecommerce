...
const loginPopup = document.getElementById('login-popup');
        ...
        function openPopup() {
            loginPopup.classList.remove('hidden'); // Menghilangkan kelas hidden
            setTimeout(() => {
                loginPopup.classList.add('popup-enter-active'); // Menambahkan kelas transisi
            }, 10); // Delay sedikit untuk memastikan transisi terlihat
        }
        ...
        function closePopup() {
            loginPopup.classList.remove('popup-enter-active'); // Menghapus kelas untuk memulai transisi keluar
            loginPopup.classList.add('popup-leave'); // Menambahkan kelas untuk menutup popup
            setTimeout(() => {
                loginPopup.classList.add('hidden'); // Menyembunyikan popup setelah animasi selesai
            }, 300); // Durasi sama dengan durasi transisi keluar
        }
